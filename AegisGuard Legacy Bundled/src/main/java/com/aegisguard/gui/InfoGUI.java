...
public class InfoGUI {
    ...
    private void buildQuickstartSection(Player player, Inventory inv) {
        ...
        inv.setItem(12, infoCard(player, CompatMaterial.resolve("LIGHTNING_ROD", "BLAZE_ROD"), "codex_start_wand_name", "&eGet The Aegis Scepter",
    ...
    private void buildClaimingSection(Player player, Inventory inv) {
        inv.setItem(10, infoCard(player, CompatMaterial.resolve("LIGHTNING_ROD", "BLAZE_ROD"), "codex_claim_step1_name", "&eGet Your Scepter",
    ...
    private void buildIdentitySection(Player player, Inventory inv) {
        ...
        inv.setItem(14, infoCard(player, CompatMaterial.resolve("GLOW_ITEM_FRAME", "ITEM_FRAME"), "codex_identity_presentation_name", "&aPresentation",
        ...
        inv.setItem(24, infoCard(player, CompatMaterial.resolve("GLOW_ITEM_FRAME", "ITEM_FRAME"), "codex_identity_showcase_name", "&ePresentation",
    ...
    private void buildAdvancedSection(Player player, Inventory inv) {
        ...
        inv.setItem(16, infoCard(player, CompatMaterial.resolve("RECOVERY_COMPASS", "COMPASS"), "codex_advanced_recovery_name", "&bRecovery & Safety",
