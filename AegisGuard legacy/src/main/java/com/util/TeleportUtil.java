...
public final class TeleportUtil {
     ...
     */
    private static final Method TELEPORT_ASYNC_METHOD;
    ...
    static {
        ...
        TELEPORT_ASYNC_METHOD = teleportAsync;
    }
    ...
    public static CompletableFuture<Boolean> safeTeleport(Plugin plugin, Entity entity, Location target) {
        ...
        if (TELEPORT_ASYNC_METHOD != null) {
            try {
                ...
                CompletableFuture<Boolean> future = (CompletableFuture<Boolean>) TELEPORT_ASYNC_METHOD.invoke(entity, loc);
                ...
                plugin.getLogger().log(Level.FINE,
                        "[AegisGuard] teleportAsync invocation failed, falling back to sync teleport.", ex);
            }
        }
