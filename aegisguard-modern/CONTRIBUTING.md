...
Thank you for contributing to AegisGuard 1.4.0. This project is a Paper/Folia territory-protection plugin built with Maven and Java 21.
...
- `AegisGuard-1.4.0.jar` — the server plugin
- `AegisGuard-1.4.0-api.jar` — the public developer API library, not a server plugin
- `AegisGuard-1.4.0-dev-api.jar` — a compatibility copy of the developer API, not a server plugin
