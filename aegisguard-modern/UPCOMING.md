...
Roles GUI lock/undo buttons and Open House gatherings now ship in 1.4.0. A Plasmo Voice hook remains a later follow-up if a server uses that stack instead of Simple Voice Chat. AegisGuard will not ship its own microphone client.
