...
public class AGConfig {
    ...
    public void reload() {
        ...
        this.upkeepEnabled = config.getBoolean("upkeep.enabled", true);
    ...
    public int getTitleFadeIn() {
        return config.getInt("titles.claim_enter_exit.fade_in",
                config.getInt("titles.fade_in", 10));
    }
    public int getTitleStay() {
        return config.getInt("titles.claim_enter_exit.stay",
                config.getInt("titles.stay", 40));
    }
    public int getTitleFadeOut() {
        return config.getInt("titles.claim_enter_exit.fade_out",
                config.getInt("titles.fade_out", 10));
    }
