param(
    ...
    [string]$Artifact = "$PSScriptRoot\..\aegisguard-modern\target\AegisGuard-1.4.0.jar",
...
foreach ($server in $servers) {
    ...
    Copy-Item -LiteralPath $artifactPath -Destination (Join-Path $plugins "AegisGuard-1.4.0.jar") -Force
