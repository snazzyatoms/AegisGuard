...
public class ExpansionRequestGUI {
    ...
    public void open(Player player) {
        ...
        inv.setItem(11, GUIManager.createItem(
                ...
                plugin.msg().get(player, "expansion_tier1_name", "§aSmall Upgrade (+5)"),
        ...
        inv.setItem(12, GUIManager.createItem(
                ...
                plugin.msg().get(player, "expansion_tier2_name", "§eMedium Upgrade (+10)"),
        ...
        inv.setItem(13, GUIManager.createItem(
                ...
                plugin.msg().get(player, "expansion_tier3_name", "§fLarge Upgrade (+20)"),
        ...
        inv.setItem(14, GUIManager.createItem(
                ...
                plugin.msg().get(player, "expansion_tier4_name", "§6Huge Upgrade (+35)"),
        ...
        inv.setItem(15, GUIManager.createItem(
                ...
                plugin.msg().get(player, "expansion_tier5_name", "§bMassive Upgrade (+50)"),
    ...
    private void submit(Player player, Plot plot, int newRadius) {
        ...
        // Feedback & UX:
        // 1) Tell the player it worked
        plugin.msg().send(player, "expansion_submitted");

        // 2) Play the confirm sound
        plugin.effects().playConfirm(player);

        // 3) Return them to the Guardian Codex instead of dumping them out
        plugin.gui().openMain(player);
    }
